...
import {
  EffectWrapper
} from "./chunk-BVOORYB5.js";
import {
  BaseTexture,
  Texture
} from "./chunk-V3422GCZ.js";
import {
  SerializationHelper
} from "./chunk-SGBI4HBC.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-XSTEVDY3.js").then((module) => this._dumpTools = module);
    }
...
function _GetCompatibleTextureLoader(extension, mimeType) {
  ...
  if (!RegisteredTextureLoaders.has(extension)) {
    if (extension.endsWith(".ies")) {
      registerTextureLoader(".ies", async () => await import("./iesTextureLoader-4N22LKKI.js").then((module) => new module._IESTextureLoader()));
    }
    if (extension.endsWith(".dds")) {
      registerTextureLoader(".dds", async () => await import("./ddsTextureLoader-3OGL5VPF.js").then((module) => new module._DDSTextureLoader()));
    }
    if (extension.endsWith(".basis")) {
      registerTextureLoader(".basis", async () => await import("./basisTextureLoader-AHWTNUEA.js").then((module) => new module._BasisTextureLoader()));
    }
    if (extension.endsWith(".env")) {
      registerTextureLoader(".env", async () => await import("./envTextureLoader-TEU4W6PW.js").then((module) => new module._ENVTextureLoader()));
    }
    if (extension.endsWith(".hdr")) {
      registerTextureLoader(".hdr", async () => await import("./hdrTextureLoader-YF7AOURG.js").then((module) => new module._HDRTextureLoader()));
    }
    if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
      registerTextureLoader(".ktx", async () => await import("./ktxTextureLoader-3RYTU6OL.js").then((module) => new module._KTXTextureLoader()));
      registerTextureLoader(".ktx2", async () => await import("./ktxTextureLoader-3RYTU6OL.js").then((module) => new module._KTXTextureLoader()));
    }
    if (extension.endsWith(".tga")) {
      registerTextureLoader(".tga", async () => await import("./tgaTextureLoader-KILIEP6L.js").then((module) => new module._TGATextureLoader()));
    }
    if (extension.endsWith(".exr")) {
      registerTextureLoader(".exr", async () => await import("./exrTextureLoader-C6SAL2TM.js").then((module) => new module._ExrTextureLoader()));
    }
  }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callbackAsync = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-R42NOY4Z.js");
    const textures = [];
...
async function ReadPixelsUsingRTT(texture, width, height, face, lod) {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      ...
      await import("./lod.fragment-I57BVMJH.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-OZI7LR3H.js");
    } else {
      await import("./lod.fragment-7YPP3UUE.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-4OXO4N75.js.map
